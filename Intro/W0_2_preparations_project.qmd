...
By using a tracking app, your phone will collect your movement data automatically. There are different types of tracking apps, from tracking specific activities to passivly tracking 24 hours. Here is a not conclusive list of tracking tools you could use. But fill free to use your own tracking tool if you already using one:

| Name             | Tracking Type | Information | Collect data | Export data |
|------------------|---------------|-------------|--------------|-------------|
| Strava           | per Activity  | [Link](https://www.strava.com/about) | [Link](https://support.strava.com/hc/en-us/articles/216917397-Recording-an-Activity) | [Link](https://support.strava.com/hc/en-us/articles/216918437-Exporting-your-Data-and-Bulk-Export) |
| Posmo            | 24h Tracking  | [Link](https://posmo.coop/products/tracking) | [Link](https://posmo.coop/produkte/faq) | [Link](https://posmo.datamap.io) |
| Komoot           | per Activity  | [Link](https://www.komoot.com/) | [Link]() | [Link](https://support.komoot.com/hc/de/articles/360022834132-GPS-Dateien-exportieren-und-importieren) |
| Garmin + Watch   | per Activity  | [Link](https://www.garmin.com/) | [Link](https://support.garmin.com/de-CH/?faq=W1TvTPW8JZ6LfJSfK512Q8) | [Link](https://support.garmin.com/de-CH/?faq=W1TvTPW8JZ6LfJSfK512Q8) |
| Google Timeline  | 24h Tracking  | [Link](https://support.google.com/maps/answer/6258979) | [Link](https://www.businessinsider.com/guides/tech/google-maps-timeline) | [Link](https://support.google.com/maps/answer/6258979) |
