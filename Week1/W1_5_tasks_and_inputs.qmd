...
3. Download the wildboar movement data here: [wildschwein_BE.csv](https://moodle.zhaw.ch/mod/folder/view.php?id=1192125)
...
Commit your changes as described in @nte-committing. Write a meaningful commit message (e.g. "`completed task 1`").
...
Commit your changes as described in @nte-committing. Have a look at your commit history by clicking on "History" in the "Git"-Pane.
...
Commit your changes as described in @nte-committing.
...
Commit your changes as described in @nte-committing. Remember to add a meaningful commit message (e.g. `completed task 5`).
