...
- Change "Project directory name" to `cma-week2-rexercise` (if you are following [the convention we proposed last week](#folder-structure))
...
**PS**: You just created an RStudio Project which is automatically connected to Github. You can also connect existing local Git repositories (e.g. from week 1) to Github. 
<!-- You have the chance to learn this in [Week 3](#w3-preparation). -->
